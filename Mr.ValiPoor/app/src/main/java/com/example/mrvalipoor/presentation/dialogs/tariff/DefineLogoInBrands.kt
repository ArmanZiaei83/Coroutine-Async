...
class DefineLogoInBrands : Dialog {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.define_logo_in_brands);

        inputNumber = findViewById(R.id.defineLogoBrandPrice)
        submit = findViewById(R.id.submitLogoBrandPrice)
    ...
    private fun checkInput() {
        submit.setOnClickListener{
            if (inputNumber.text.toString().isNullOrEmpty()){
                ...
                passString.defineLogoInBrands(inputNumber.text.toString())
                dismiss()
            }
        }
    }
