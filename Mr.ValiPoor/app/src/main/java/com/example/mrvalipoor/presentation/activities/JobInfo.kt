...
class JobInfo : AppCompatActivity(), View.OnClickListener, OnPassData{
    ...
    private fun setCancelOnClick() {
        cancel.setOnClickListener{
            val toJobs = Intent(this , AcceptJobs::class.java)
    ...
    private fun setItemsData() {
        ...
        phone.text = phone.text.toString() + bundle.get("phone").toString()
    ...
    private fun setUi() {
        constraintLayout = findViewById(R.id.infotConstraintLayout)
        title = findViewById(R.id.infoTitle)
        part = findViewById(R.id.infoPart)
        infoState = findViewById(R.id.infoState)
        phone = findViewById(R.id.infoPhone)
        email = findViewById(R.id.infoEmail)
        showButton = findViewById(R.id.infoShowGift)
        hideButton = findViewById(R.id.infoHideGift)
        logoHistory = findViewById(R.id.logoGiftHistory)
        callHistory = findViewById(R.id.freeCallGiftHistory)
        setLogoGift = findViewById(R.id.infoLogoGift)
        setCallgift = findViewById(R.id.infoCallGift)
        submit = findViewById(R.id.submit)
        cancel = findViewById(R.id.cancel)

        spamClose = findViewById(R.id.jobHide)
        spamOpen = findViewById(R.id.jobShow)

        isAccepted = findViewById(R.id.isAccepted)
        backToMain = findViewById(R.id.infoBack)
    ...
    private fun goToMain() {
        val toMain = Intent(this , AcceptJobs::class.java)
