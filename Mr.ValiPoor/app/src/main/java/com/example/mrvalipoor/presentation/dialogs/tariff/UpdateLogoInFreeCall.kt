...
class UpdateLogoInFreeCall : Dialog {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.update_logo_in_free_call);

        inputNumber = findViewById(R.id.updateLogoPrice)
        submit = findViewById(R.id.submitLogoPrice)
    ...
    private fun checkInput() {
        submit.setOnClickListener{
            if (inputNumber.text.toString().isNullOrEmpty()){
                ...
                passString.updateLogoInFreeCall(inputNumber.text.toString())
                dismiss()
            }
        }
    }
