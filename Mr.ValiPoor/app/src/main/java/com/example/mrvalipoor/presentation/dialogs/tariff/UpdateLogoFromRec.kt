...
class UpdateLogoFromRec : Dialog {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.update_logo_from_rec);

        inputNumber = findViewById(R.id.updateLogoFromRec)
        submit = findViewById(R.id.submitLogoFromRec)
    ...
    private fun checkInput() {
        submit.setOnClickListener{
            if (inputNumber.text.toString().isNullOrEmpty()){
                ...
                passString.defineLogoInRec(inputNumber.text.toString())
                dismiss()
            }
        }
    }
