package com.example.getgithubapi.ViewModels;
...
import com.example.getgithubapi.Retrofit.GetRepo;
import com.example.getgithubapi.Retrofit.Repo;
import com.example.getgithubapi.Retrofit.RetrofitHolder;
...
public class ViewModel extends androidx.lifecycle.ViewModel {
    ...
    public void deleteData(int id){
       ...
       Completable.fromAction(new Action() {
           @Override
           public void run() throws Exception {
               RecViewModel model = new RecViewModel();
